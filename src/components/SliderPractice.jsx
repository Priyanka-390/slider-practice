...
function SliderPractice() {
  ...
  return (
    <div className="max-w-[1440px] px-4 mx-auto">
      <h1 className="font-extralight italic underline font-mono text-center md:text-7xl sm:text-6xl text-5xl">
        SLIDER
      </h1>
          ...
          >
            {SLIDER_DATA_LIST.map((data, i) => (
              <div key={i}>
                <img
                  src={data}
                  className="lg:min-h-48 rounded-xl lg:min-w-64 lg:h-48 h-36 w-40 sm:w-52 md:w-64"
                  alt="images"
                />
              </div>
            ))}
